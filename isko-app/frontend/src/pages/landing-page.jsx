  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col justify-center gap-6">
            ...
            <p className="text-balance text-lg text-muted-foreground">
              Transform your study sessions with AI-powered tools, spaced repetition, and interactive lessons
          ...
          <div className="grid gap-4">
            <Card className="border border-border/50 bg-gradient-to-br from-card via-card to-muted/40 hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            return (
              ...
              >
                <CardHeader>
                  <div className={`rounded-lg bg-gradient-to-br ${feature.color} to-muted/20 w-fit p-3 mb-4 group-hover:scale-110 transition-transform duration-300`}>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        <Card className="border border-primary/20 bg-gradient-to-r from-primary/5 via-primary/3 to-accent/5 overflow-hidden">
      ...
      <footer className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <div className="mt-12 border-t border-border/50 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-muted-foreground">
              © 2026 IskoAI. All rights reserved.
            </p>
